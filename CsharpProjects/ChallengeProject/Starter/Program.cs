...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (petCount = 0; petCount < maxPets; petCount++)
            {
                animalID = ourAnimals[petCount, 0];
                if (animalID != "ID #: ")
                {
                    if (!int.TryParse(ourAnimals[petCount, 2].Substring(5), out petAge))
                    {
                        do
                        {
                    ...
                    animalPhysicalDescription = ourAnimals[petCount, 4].Substring(22);
                    if ((animalPhysicalDescription == null) || (animalPhysicalDescription == ""))
                    {
                        do
                        {
        ...
        case "4":
            ...
            for (petCount = 0; petCount < maxPets; petCount++)
            {
                ...
                if (animalID != "ID #: ")
                {
                    animalNickname = ourAnimals[petCount, 3].Substring(10);
                    if ((animalNickname == null) || (animalNickname == ""))
                    {
                        do
                        {
                    ...
                    animalPersonalityDescription = ourAnimals[petCount, 5].Substring(13);
                    if ((animalPersonalityDescription == null) || (animalPersonalityDescription == ""))
                    {
                        do
                        {
                        ...
                        ourAnimals[petCount, 5] = "Nickname: " + animalPersonalityDescription;
                    }
                }
            }
